...
export default function RicePage() {
  ...
  const fetchHeroText = async () => {
    try {
      const heroTextDoc = doc(db, 'heroTexts', 'products-rice');
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative w-full h-screen flex items-center overflow-hidden">
        {/* Animated rice/green gradient background */}
        <motion.div
          className="absolute inset-0 z-0"
          initial={{ background: 'linear-gradient(135deg, #065f46 0%, #047857 50%, #059669 100%)' }}
          animate={{ background: [
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 h-full flex flex-col justify-center">
          <div className="max-w-4xl lg:max-w-5xl text-center w-full mx-auto">
            ...
            >
              {heroLoading ? (
                <div className="animate-pulse">
                  <div className="h-12 sm:h-16 md:h-20 lg:h-24 xl:h-28 bg-yellow-200/50 rounded-lg"></div>
                </div>
              ) : heroText ? (
                <>
                  <motion.span
            ...
            {heroLoading ? (
              ...
              >
                <div className="animate-pulse">
                  <div className="h-6 sm:h-8 bg-yellow-200/30 rounded-lg mb-2"></div>
                  <div className="h-6 sm:h-8 bg-yellow-200/20 rounded-lg"></div>
                </div>
              </motion.div>
