    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        >
          ...
          <motion.div
            className="absolute left-1/3 bottom-1/4 w-18 h-18 bg-orange-500/30 rounded-full flex items-center justify-center"
            animate={{ y: [0, 50, 0], rotate: [0, 15, -15, 0] }}
            transition={{ duration: 11, repeat: Infinity, ease: 'easeInOut', delay: 1 }}
          >
            <svg className="w-9 h-9 text-orange-600" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
            </svg>
          </motion.div>
          <motion.div
