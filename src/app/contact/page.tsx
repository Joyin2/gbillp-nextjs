  ...
  return (
    <div className="min-h-screen font-sans bg-gray-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              {/* Contact Form */}
              <motion.div
                className="relative bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-2xl border border-emerald-100/50"
              ...
              >
                <motion.div
                  className="absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-r from-emerald-500/10 to-teal-500/10"
                ...
                <p className="text-gray-600 mb-6 sm:mb-8 text-center text-base sm:text-lg font-medium">
      ...
      <section className="relative py-8 sm:py-12">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <motion.div
            className="w-full h-[400px] sm:h-[500px] lg:h-[600px] rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border border-emerald-100/50"
          ...
          <motion.div
            className="absolute bottom-8 sm:bottom-16 left-1/2 transform -translate-x-1/2 w-full max-w-sm sm:max-w-md px-4 sm:px-0"
